...
Event::Event(std::string uniqueID, TimeStamp tstamp)
{
...
std::string Event::getUniqueID(void)
{
	return this->uniqueID;
}

TimeStamp Event::getTimeStamp(void)
{
	return this->tstamp;
}

void Event::setUniqueID(std::string uniqueID)
{
	this->uniqueID = uniqueID;
}

void Event::setTimeStamp(TimeStamp tstamp)
{
	this->tstamp = tstamp;
}
