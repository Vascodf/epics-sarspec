		...
		namespace core
		{
			namespace time
			{
				...
				class Time
				{
					...
					public:
						Time(void);
						Time(char hours, char minutes, char seconds, short millis, short micros, short nanos, short picos);
					...
					public:
						...
						short getMillis(void);
						short getMicros(void);
						short getNanos(void);
						short getPicos(void);
						void setHours(char hours);
						void setMinutes(char minutes);
						void setSeconds(char seconds);
						void setMillis(short millis);
						void setMicros(short micros);
						void setNanos(short nanos);
						void setPicos(short picos);
