		...
		namespace core
		{
			namespace client
			{
				...
				class SdasClient
				{
					...
					public:
						SdasClient(string hostname, int port, string cred);
						SdasClient(string hostname, int port) { new (this) SdasClient(hostname, port, ""); }
					...
					private:
                        ...
                        XmlRpcValue createXmlRpcValueFromExtraInfo(map<string,string> extraInfo);
                        XmlRpcValue createXmlRpcValueFromErrorInfo(ErrorInfo errori);
                        ...
                        ErrorInfo createErrorInfoStructureFromXmlRpcValue(XmlRpcValue rpcValue);
					...
					public:
                        ...
                        bool parameterExists(string uniqueID, string eventUniqueID, int eventNumber);
					...
					// Data Retrieving
					//
					vector<Data> getData(string parameterUniqueID, string eventUniqueID, int eventNumber);
					vector<Data> getData(string parameterUniqueID, HEvent hevent);
					vector<vector<Data> > getMultipleData(vector<string> parameterUniqueID, vector<string> eventUniqueID, vector<int> eventNumber);
					vector<vector<Data> > getMultipleData(vector<string> parameterUniqueID, vector<HEvent> hevent);
					vector<vector<Data> > getMultipleData(vector<string> parameterUniqueID, HEvent hevent);
					vector<vector<Data> > getMultipleData(vector<string> parameterUniqueID, string eventUniqueID, int eventNumber);
					vector<vector<Data> > getMultipleData(string parameterUniqueID, vector<string> eventUniqueID, vector<int> eventNumber);
					vector<vector<Data> > getMultipleData(string parameterUniqueID, string eventUniqueID, vector<int> eventNumber);
                    ...
                    // Authentication
                    //
                    string authenticate(string credentials[2]);
				};
